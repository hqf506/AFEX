...
assert(api.includes("'[auth-recovery] supabase request failed:'") && api.includes("process.env.NODE_ENV !== 'production'"), 'Recovery diagnostics must be failure-only in Production.')
