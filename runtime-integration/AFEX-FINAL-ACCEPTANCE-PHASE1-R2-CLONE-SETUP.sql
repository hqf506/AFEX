...
$function$;
revoke all on function public.verify_pos_pin_for_actor(text,uuid,uuid) from public,anon,authenticated;
grant execute on function public.verify_pos_pin_for_actor(text,uuid,uuid) to service_role;
