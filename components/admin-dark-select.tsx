      ...
      {open && !disabled && menuPosition && typeof document !== 'undefined'
        ? createPortal(
            <div
              ...
              className={`z-[13000] overflow-y-auto rounded-2xl border border-cyan-300/15 bg-[#06111f] p-1 text-right shadow-[0_24px_70px_rgba(0,0,0,0.42)] backdrop-blur-xl ${menuClassName}`}
            >
              {options.map((option) => {
